							...
							<div class="col-lg-4  border">
								...
								<div class="row">	
									<div class="form-group">
										...
										<div class="col-md-8">
											<select name="box" id="sel" class="block form-control selectpicker" data-live-search="true" onchange="setUrlEdit(this);">
												<option value="<?= $box['id']?>">
