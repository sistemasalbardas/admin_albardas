///CONTANTES URLS->
//LOCAL 
// const URL = "localhost/admin_albardas/";  
//PRODUCCION
...
//FUNCIONES AJAX PARA EL MODULO DE COMPRAS
...
function addProvider(obj) {
    ...
    var formData = new FormData($(obj)[0]);
    $.ajax({
        url: URL+"purchasing/addsupplier/",
        type: 'POST',
        data: formData,
        contentType: false,
        processData: false,
        ...
        success: function(status){
            swal("Ok!", "Proveedor guardado", "success");   
            $(obj)[0].reset();
            location.reload(); 
...
function deleteProvider(obj){
    ...
    .then((willDelete) => {
      if (willDelete) {
        $.ajax({
            url: URL+'purchasing/deletesupplier/?id='+id,
            type: "GET",
            data: "",
            contentType: false,
            processData: false,
